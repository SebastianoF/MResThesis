...
%{\bf Chapter \ref{ch:log_algorithm}} is about the algorithm for the computation of the Lie logarithm \cite{Bossa:08}, called here logarithm computation algorithm. 
...
This last chapter is devoted to show most relevant results of the numerical methods investigated.
