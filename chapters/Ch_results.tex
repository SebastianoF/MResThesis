...
Numerical tests show that for the studied cases, no qualitative differences are detected if choosing instead the $L^{2}$ norm.
 ...
 \begin{figure}[!ht]
 	\hspace{-2cm}
 	\includegraphics[scale=0.54]{figures/se2_image_scale.pdf}
...
\begin{figure}[!ht]
	\hspace{-1.5cm}
	\includegraphics[scale=0.54]{figures/se2_boxplot.pdf}
...
\begin{figure}[!ht]
	\hspace{-0.8cm}
	\includegraphics[scale=0.72]{figures/svf_gaussian_smoothing_effects.pdf}
...
\begin{figure}[!ht]
	\hspace{-1.5cm}
	\includegraphics[scale=0.54]{figures/SVF_sigma_means_comparisons.pdf}
...
\begin{figure}[!ht]
	\hspace{-1cm}
	\includegraphics[scale=0.6]{figures/SVF_image_scale_bracket_versus_gaussian.pdf}
...
Other problems of the computation in consequence of the fact that the Jacobian is utilized in the Lie bracket from Marcos' paper. The 
