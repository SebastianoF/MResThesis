...
As previously said in section \ref{se:diffe_util_and_liab}, the passage from the finite to the infinite dimensional case is not free of deceptions.
% difference number 1) bigger algebra. From here introduce the structure.

% deformation, homeomorphisms, diffeomorphisms. map V and displacements. Structures. Figure


% Taylor expansion series. refer to the two doors!


% lack of bigger algebra for diffeomorphisms
...
In the case of matrices, the exponential map is a local isomorphisms: it is always possible to find an open neighbor of the $\mathbf{0}$ in the Lie algebra and an open neighbor of the identity element in the Lie group, in the same metric inherited by the bigger algebra, such that the exponential map is 

% diffeomorphisms arbitrairly closed to the neutral elements Milnor counterexample
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
\subsection{One-parameter Subgroup Generated by Stationary Velocity Fields}
