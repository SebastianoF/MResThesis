...
% % % % % % % % % % % % % % % % % %
% % % % % % % % % % % % % % % % % % %
\section{Parametrization of SVF: grids and vectors}

Approccio fino ad ora: come mai modellare nel continuo per passare dopo nel discreto.
Il passaggio nel discreto

Dobbiamo in particolare giustificare l'assunzione fatta!
