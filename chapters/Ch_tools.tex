...
\end{align*}
where $\gamma: [0,1]\rightarrow \mathbb{G} $ is the unique one-parameter subgroup of $\mathbb{G}$ having $\mathbf{v}$ as its tangent vector at the identity, indicated for the general case with $e$ \cite{do1992riemannian}, \cite{ebin2006singularities}, \cite{Arsigny:MRM:06}.
