...
The Lie Log-composition (Lie to distinguish it from the Affine Log-composition of the next section) is defined here as the inner binary operation on the Lie algebra that reflects the composition on the lie group:
\begin{align*}
