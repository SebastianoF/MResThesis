...
\begin{figure}[htbp]
	...
	\begin{minipage}[b]{3cm}
		\hspace{-4cm}
		\centering
		\includegraphics[width=6.5cm]{figures/inversion_1.pdf}
	...
	\begin{minipage}[b]{4cm}
		\centering
		\includegraphics[width=6.5cm]{figures/inversion_2.pdf}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=9.5cm]{figures/theorem_pict.pdf}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=7.5cm]{figures/u_plus_v_parallel_transported.pdf}
...
With the truncated BCH and the Taylor expansion, equation \ref{eq:parallel_transport} is the third numerical method for the computation of the log-composition explored in this thesis. The next chapter is devote to introduce the two group of transformation that will be considered in this research and to the applications of the numerical methods developed so far.
