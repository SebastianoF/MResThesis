...
The discretized vector fields that can be stored in the computers' memory, are 5-dimensional matrix on a regular lattice $L$ over the background space $\Omega$.
